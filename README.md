...
/proofs - Preuves matérielles (fichiers sources analysés)
      ...
      firmware/ — extraits bruts issus du firmware (scan nmap, hash admin, endpoint d'upload non vérifié)
      mobile/ — fichiers sources vulnérables extraits de l'APK (manifest, classes Java, shared_prefs)
